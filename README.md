...
The configuration file is located at `~/cgpterm/config.ini` and is autogenerated. It can be modified using the program's `--set` option or edited manually.
...
You can also use `/exit` command or `Ctrl_D` to exit directly.
...
This project is licensed under the [GPLv3 License](https://github.com/Ace-Radom/cGPTerm/blob/main/LICENSE) after v1.0.0 release.
